...
forever(function () {
    ...
    Bogey.setPosition(160, randint(25, 115))
    Bogey.setFlag(SpriteFlag.AutoDestroy, true)
    pause(Bogey_Regen_Speed)
})
forever(function () {
    if (spacePlane.y <= 25) {
        spacePlane.y = 25
...
game.onUpdateInterval(Heal_Pack_Regen_Speed, function () {
    Heal_Pack = sprites.create(img`
        ....................
        ....................
        ....................
        ....................
        ...
        ....................
        `, SpriteKind.Food)
    Heal_Pack.setVelocity(-200, 0)
    Heal_Pack.setPosition(160, randint(25, 115))
    Heal_Pack.setFlag(SpriteFlag.AutoDestroy, true)
})
